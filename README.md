...
**Atlas — отдельный релиз ребрендинга и RU/KK/EN.** Конкурсная версия HackAlem сохранена тегом `submission-2026-09-23` (`1c397c1`); изменения Atlas не относятся к исходной сдаче.
...
git switch release/atlas-rebrand
npm ci
npm run build
npm start
```
